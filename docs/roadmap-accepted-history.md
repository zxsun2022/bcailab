...
## Next — Writing: targeted practice after feedback — accepted (2026-09-25)

Shipped in PR #84. Moved here from `docs/roadmap.md` Next on acceptance; text kept as it stood.
...
- **Acceptance.**
  ...
  - (j) **Docs.** A practice section in `docs/tools/writing.md`, and a changelog entry marked
    `in_review`.
- **Progress.** in_review (2026-09-25); **accepted by the owner 2026-09-25**: all of (a)–(j) implemented; evidence in
...
## Next — English Studio UX batch — accepted (2026-09-25)

Shipped in PR #85. Moved here from `docs/roadmap.md` Next on acceptance; text kept as it stood.
...
- **Progress.** in_review (2026-09-25); **accepted by the owner 2026-09-25**: all four sections done; evidence in `docs/changelog.md`.

## Next — Free entry points made explicit — accepted (2026-09-25)

Shipped in PR #86. Moved here from `docs/roadmap.md` Next on acceptance; text kept as it stood.
...
- **Progress.** in_review (2026-09-25); **accepted by the owner 2026-09-25**; evidence in `docs/changelog.md`.
