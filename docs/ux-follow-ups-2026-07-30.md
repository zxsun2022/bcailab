...
| 2. Translate source editor growth | **Done (accepted 2026-09-25)** | 2026-09-25 UX batch: the source is content-sized on desktop, and on mobile once a result exists |
...
| 3C. Dictation audio duration | **Done (accepted 2026-09-25)** | 2026-09-25 UX batch: `m:ss` beside the controls after metadata loads, following the speed |
| 3D. Check shortcut discoverability | **Done (accepted 2026-09-25)** | 2026-09-25 UX batch: hint under the answer; also fixed Enter not advancing after a check |
| 4. Return controls placement | Not verified | Needs a visual pass across Reading, Dictation and Writing detail pages |
| 5. Reading "Add text" into "Your texts" | **Done (accepted 2026-09-25)** | 2026-09-25 UX batch: in the Your texts header, empty and populated |
