...
- **Chinese interface for Chinese-speaking learners (stages 1–3) — accepted (2026-09-22)** — already accepted. [Original scope and evidence](roadmap-accepted-history.md#now--chinese-interface-for-chinese-speaking-learners--accepted-2026-09-22); [delivery record](changelog.md); decisions in [ADR 0011](decisions/0011-chinese-ui-same-url-feedback-follows-interface.md).
