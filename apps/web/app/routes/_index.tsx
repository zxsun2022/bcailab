      ...
      <section className="features-section">
        <div className="features-grid">
          <div className="feature">
            ...
            <h4 className="feature-title">Single Sign-On</h4>
            <p className="feature-desc">One Google account for all tools</p>
          </div>
          <div className="feature">
            <div className="feature-icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <p className="feature-desc">Fast, minimal, no bloat</p>
          </div>
          <div className="feature">
            <div className="feature-icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <h4 className="feature-title">Edge-First</h4>
            <p className="feature-desc">Deployed on Cloudflare globally</p>
          </div>
        </div>
      </section>
    </div>
